...
public class ReportTemplate_UserReport extends BasePage {
	...
	public ReportTemplate_UserReport(WebDriver driver) {
		super(driver);
	}
...
//Clicking on New account report link
		...
		Reports.createNewReportTemplate_UserReport_link(driver).click();
		...
		//Sub header text validation
			String Create_new_report_subtitle_exp1 = "Create a report template based on New user report report model";
...
//Creating the new Ship report by selecting/filling all the required details
	...
	//Randomly selecting the options from the drop down		
			...
			if(random == 1){
				...
				select.selectByVisibleText("Is active");
			}
	...
	if(selected_Filter_option == "First name"){
		...
		WebElement dropdown3 = Reports.create_new_report_filter_ShipReports_NewShipReport_Filters_exactly_type(driver);
		 Select select3 = new Select(dropdown3);  

		 //Selecting the True drop down value
		 
		 select3.selectByVisibleText("True");
...
//Validating the created account report template details
	...
	if(dropdown_filters_1row_1column_act == "First name"){
	...
	}else if(dropdown_filters_1row_1column_act == "Email"){
	...
	}else if(dropdown_filters_1row_1column_act == "Is active"){
		...
		WebElement dropdown_filters_1row_2column1 = driver.findElement(By.xpath("//div[2]/div[2]/select"));
		 ...
		 WebElement dropdown_filters_1row_2column2 = driver.findElement(By.xpath("//div[2]/div[3]/select"));
		 
			
		 Select select_filters2_2 = new Select(dropdown_filters_1row_2column1);  
		 
		 String dropdown_filters_1row_2column_act2 = dropdown_filters_1row_2column2.getText();
		 
		 Assert.assertEquals(dropdown_filters_1row_2column_act2, "True");
		 
		Log.info("Filters section first row details are correct when Is active is selected");
