...
public class ReportTemplate_AccountReport extends BasePage {
	...
	public ReportTemplate_AccountReport(WebDriver driver) {
		super(driver);
	}
...
//Clicking on New account report link
		...
		Reports.createNewReportTemplate_AccountReport_link(driver).click();
		...
		//Sub header text validation
			String Create_new_report_subtitle_exp1 = "Create a report template based on New account report report model";
...
//Creating the new Ship report by selecting/filling all the required details
	...
	if(selected_Filter_option == "Status"){
		...
		String[] exp1 = {"Active","Deleted"};
		 ...
		 driver.findElement(By.xpath("//div[2]/div[2]/div[2]/div[2]/div/div[2]/div/form/div/div[3]/div[2]/div[3]/input")).sendKeys("123");
		...
		WebElement dropdown3 = Reports.create_new_report_filter_ShipReports_NewShipReport_Filters_exactly(driver);
		 ...
		 String CompanyName_given = driver.findElement(By.xpath("//div[2]/div[2]/div[2]/div[2]/div/div[2]/div/form/div/div[3]/div[2]/div[3]/input")).getText();
