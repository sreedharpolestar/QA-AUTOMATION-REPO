...
public class UsersFunctional {
	...
	public void createNewUser() throws Throwable{
		...
		// Input test data
		Users.new_users_role(driver).click();
		Users.new_users_role_administrator(driver).click();
		//new Select(Users.new_users_role(driver)).selectByVisibleText(UsersTestData.users_role_administrator_list);
		log.info("The role selected is : " + UsersTestData.users_role_administrator_list);
		Thread.sleep(3000);
		...
		Assert.assertEquals(UsersTestData.users_email, email_enetered);
		log.info("The email is same as the data entered : " + email_enetered);
