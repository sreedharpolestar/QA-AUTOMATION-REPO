...
public class Users 
{
	...
	public static WebElement new_users_email(WebDriver driver) throws Throwable{
		element = driver.findElement(By.id("form__item__email"));
	...
	public static WebElement new_users_first_name(WebDriver driver){
		element = driver.findElement(By.cssSelector("#form__item__first_name"));	
		return element;
	}
	...
	public static WebElement new_users_account_type_select_account_link(WebDriver driver){
		element = driver.findElement(By.xpath("//div[2]/div[2]/div[2]/div[2]/div/div[2]/div/form/div[2]/div[4]/div/div/ul/li/a"));
		return element;
	...
	/*public static WebElement new_users_role(WebDriver driver){
		element = driver.findElement(By.cssSelector("#form__item__user_profile_role"));
		return element;
	}*/
	
	/*public static WebElement new_users_role_administrator(WebDriver driver){
		element = driver.findElement(By.xpath("//api/v1/role/1]"));
		return element;
		
		//*[@id="form__item__user_profile_role"]
	}*/
	...
	public static WebElement users_add_services_page(WebDriver driver) {
		element = driver.findElement(By.xpath("//div[1]/div/h3"));
	...
	public static WebElement users_sort_by_name(WebDriver driver) {
		element = driver.findElement(By.xpath("//div[2]/button/span[1]"));
		return element;
	}
